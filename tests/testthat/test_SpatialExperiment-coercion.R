...
test_that("SingleCellExperiment AS SpatialExperiment case 1", {
    expect_s4_class(as(sce, "SpatialExperiment"), class="SpatialExperiment")
})
...
test_that("SingleCellExperiment TO SpatialExperiment case 1" ,{
    # case 1: no arguments
    expect_s4_class(toSpatialExperiment(sce), "SpatialExperiment")
    expect_equal(toSpatialExperiment(sce), as(sce, "SpatialExperiment"))
})
