...
#' where \code{se} is a \linkS4class{SpatialExperiment} object and \code{X} is the name of the method.
...
#' In the following code snippets, \code{x} is a \linkS4class{SpatialExperiment} object,
#' \code{value} is a BumpyMatrix-like object with the same dimensions as \code{x},
#' and \code{...} are further arguments passed to \code{\link{assay}} (for the getter) 
#' or \code{\link{assay<-}} (for the setter).
#' 
#' \describe{
