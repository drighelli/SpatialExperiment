...
- `spatialCoords` is a numeric `matrix` containing only the defined (via `spatialCoordsNames`) 
spatial coordinates.
...
spe <- SpatialExperiment(
  assay=mat, spatialData=cd, spatialCoordsNames=c("x", "y")
)
...
spe <- SpatialExperiment(
  assays = asy, spatialCoords = mat, spatialData=spad, colData=cd
)
head(spatialData(spe))
head(spatialCoords(spe))
head(colData(spe))
