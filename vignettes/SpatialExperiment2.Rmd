...
For demonstration of the general class anatomy, we load an example 
...
lead to construction of the exact same object (although column orders in `colData` 
may differ, depending on which arguments were provided).
